...
namespace DijagnostickaJedinica
{
    internal class DijagnostickaJedinica
    {
        static void Main(string[] args)
        {
            Socket listener = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            listener.Bind(new IPEndPoint(IPAddress.Any, 60001));
            listener.Listen(5);
            Console.WriteLine("Dijagnostička jedinica je spremna!");
